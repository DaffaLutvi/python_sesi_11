from ecommerce.pricing import hitung_harga_setelah_diskon, hitung_pajak, hitung_total
...
def main():
    ...
    harga_setelah_diskon = hitung_harga_setelah_diskon(harga_asli, diskon)
    pajak = hitung_pajak(harga_setelah_diskon, tarif_pajak)
